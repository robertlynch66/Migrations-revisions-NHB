...
####Model_1_kids_all
kids_model <- glmer (kids ~ hypergamy + outbred + returnedkarelia + sex +  education + agricult +
                       technical + factory + service + office + business + transport + age+ married_after +
                       (1 | birthplaceid) , data=m, family="poisson")
summary(kids_model)
#### Run in rethining
